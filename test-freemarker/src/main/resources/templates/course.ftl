...
<div class="article-banner">
    ...
    <div class="banner-info">
        <div class="banner-left">
            ...
            <p class="pic"><span class="new-pic">特惠价格￥${(model.courseMarket.price)!""}</span> <span class="old-pic">原价￥${(model.courseMarket.price_old)!""}</span></p>
            <p class="info">
                <a href="http://ucenter.xuecheng.com/#/learning/${model.courseBase.id}/0"  target="_blank" v-if="learnstatus == 1" v-cloak>马上学习</a>
                <a href="#"  @click="addopencourse" v-if="learnstatus == 2" v-cloak>立即报名</a>
                <a href="#"  @click="buy" v-if="learnstatus == 3" v-cloak>立即购买</a>
                <span><em>难度等级</em>
		 <#if model.courseBase.grade=='200001'>
		低级
                <#elseif model.courseBase.grade=='200002'>
		中级
		 <#elseif model.courseBase.grade=='200003'>
		高级
		</#if>
                </span>
                ...
                <span><em>授课模式</em>
                  <#if model.courseBase.studymodel=='201001'>
		自由学习
                <#elseif model.courseBase.studymodel=='201002'>
		任务式学习
		</#if>
                </span>
            </p>
	    ...
	    <#if (model.coursePic.pic)??>
	     <p><img src="http://img.xuecheng.com/${model.coursePic.pic}" alt="" width="270" height="156"> </p>
	     <#else>
    ...
    <div class="article-box">
                ...
                <div class="article-left-box">
                    <div class="content">
                        ...
                        <div class="content-com about">
                            ...
                            <div class="cont cktop">
                                <div >
                                    <p>${(model.courseMarket.description)!""}</p>
                                </div>
                                <!--<span class="on-off">更多 <i class="i-chevron-bot"></i></span>-->
                            </div>
                        </div>
        ...
        <div class="articleItem" style="display: none">
            <div class="article-cont-catalog">
                <div class="article-left-box">
                    <div class="content">
			<#if (model.teachplanNode.children)??>
                            <#list model.teachplanNode.children as firstNode>
                                <div class="item">
...
<script>var courseId = "${model.courseBase.id}"</script>
